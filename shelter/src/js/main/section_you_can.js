...
const youCanImg = createElement('img', ['you-can-img'], '', { src: './assets/img/youCan.webp', alt: '' });
...
const youCanCardImg = createElement('img', ['you-can-card-img'], '' , { src: './assets/svg/credit-card.svg', alt: '' });
