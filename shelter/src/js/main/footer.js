...
const footerMail = createContact('a', 'mailto:mail@mail.com', emailImgSrc, 'email@shelter.com', ['mail', 'mail-img', 'mail-text']);
const footerPhone = createContact('a', 'tel:+136745677554', phoneImgSrc, '+13 674 567 75 54', ['phone', 'phone-img', 'phone-text']);
